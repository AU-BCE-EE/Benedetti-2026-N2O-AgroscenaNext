...
#dates_to_remove <- as.Date(c("2025-10-30", "2025-10-31", "2025-11-03", "2025-11-06"))
dates_to_remove <- as.Date(c("2025-10-30", "2025-10-31", "2025-11-03", "2025-11-06", "2026-01-19", "2026-01-20"))

treatments_to_keep <- c("PSAA", "PSH2SO4", "PSRAW", "CTR")
...
write.csv(emm_df, "LSM_PS_cumulate.csv", row.names = FALSE)
