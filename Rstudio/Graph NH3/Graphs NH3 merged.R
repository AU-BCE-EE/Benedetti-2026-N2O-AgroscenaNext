...
setwd("/Users/lorenzobenedetti/Desktop/Università/DiANA/Dottorato/Danimarca/AU/Agroscena Next/DFC_SC_Lorenzo_Pablo/DFC NH3")
...
make_plot <- function(dat_summary,
                      temp_df,
                      palette_auto,
                      labels_treat,
                      title_text,
...
p_cattle <- make_plot(
  ...
  global_flux_max = global_flux_max
)
